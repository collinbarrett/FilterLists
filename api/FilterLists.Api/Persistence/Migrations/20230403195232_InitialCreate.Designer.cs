...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilterLists.Api.Persistence.Entities.Dependent", b =>
                {
                    b.HasOne("FilterLists.Api.Persistence.Entities.FilterList", "DependencyFilterList")
                        .WithMany("DependentFilterLists")
                        .HasForeignKey("DependencyFilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.Persistence.Entities.FilterList", "DependentFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.Persistence.Entities.FilterListLanguage", b =>
                {
                    b.HasOne("FilterLists.Api.Persistence.Entities.FilterList", "FilterList")
                        .WithMany("FilterListLanguages")
                        .HasForeignKey("FilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.Persistence.Entities.Language", "Language")
                        .WithMany("FilterListLanguages")
            ...
            modelBuilder.Entity("FilterLists.Api.Persistence.Entities.FilterListMaintainer", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.Persistence.Entities.Maintainer", "Maintainer")
                        .WithMany("FilterListMaintainers")
            ...
            modelBuilder.Entity("FilterLists.Api.Persistence.Entities.FilterListSyntax", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.Persistence.Entities.Syntax", "Syntax")
                        .WithMany("FilterListSyntaxes")
            ...
            modelBuilder.Entity("FilterLists.Api.Persistence.Entities.FilterListTag", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.Persistence.Entities.Tag", "Tag")
                        .WithMany("FilterListTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FilterLists.Api.Persistence.Entities.Fork", b =>
                {
                    b.HasOne("FilterLists.Api.Persistence.Entities.FilterList", "ForkFilterList")
                        .WithMany("UpstreamFilterLists")
                        .HasForeignKey("ForkFilterListId")
                        .IsRequired();

                    b.HasOne("FilterLists.Api.Persistence.Entities.FilterList", "UpstreamFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.Persistence.Entities.Merge", b =>
                {
                    b.HasOne("FilterLists.Api.Persistence.Entities.FilterList", "IncludedInFilterList")
                        .WithMany("IncludesFilterLists")
                        .HasForeignKey("IncludedInFilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.Persistence.Entities.FilterList", "IncludesFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.Persistence.Entities.SoftwareSyntax", b =>
                {
                    b.HasOne("FilterLists.Api.Persistence.Entities.Software", "Software")
