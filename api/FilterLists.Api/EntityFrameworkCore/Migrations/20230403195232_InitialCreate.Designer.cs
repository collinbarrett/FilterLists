...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Dependent", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterListLanguage", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterListMaintainer", b =>
                {
                    b.Property<int>("FilterListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterListSyntax", b =>
                {
                    b.Property<int>("FilterListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterListTag", b =>
                {
                    b.Property<int>("FilterListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Fork", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.License", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Maintainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Merge", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Software", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.SoftwareSyntax", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Syntax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Dependent", b =>
                {
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", "DependencyFilterList")
                        .WithMany("DependentFilterLists")
                        .HasForeignKey("DependencyFilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", "DependentFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", b =>
                {
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.License", "License")
                        .WithMany("FilterLists")
                        .HasForeignKey("LicenseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsMany("FilterLists.Api.EntityFrameworkCore.Entities.FilterListViewUrl", "ViewUrls", b1 =>
                        {
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterListLanguage", b =>
                {
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", "FilterList")
                        .WithMany("FilterListLanguages")
                        .HasForeignKey("FilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.Language", "Language")
                        .WithMany("FilterListLanguages")
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterListMaintainer", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.Maintainer", "Maintainer")
                        .WithMany("FilterListMaintainers")
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterListSyntax", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.Syntax", "Syntax")
                        .WithMany("FilterListSyntaxes")
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.FilterListTag", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.Tag", "Tag")
                        .WithMany("FilterListTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Fork", b =>
                {
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", "ForkFilterList")
                        .WithMany("UpstreamFilterLists")
                        .HasForeignKey("ForkFilterListId")
                        .IsRequired();

                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", "UpstreamFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.Merge", b =>
                {
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", "IncludedInFilterList")
                        .WithMany("IncludesFilterLists")
                        .HasForeignKey("IncludedInFilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.FilterList", "IncludesFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.EntityFrameworkCore.Entities.SoftwareSyntax", b =>
                {
                    b.HasOne("FilterLists.Api.EntityFrameworkCore.Entities.Software", "Software")
