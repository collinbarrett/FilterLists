        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    Url = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    EmailAddress = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    TwitterHandle = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DownloadUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    OnionUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    PolicyUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    SubmissionUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    IssuesUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ForumUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ChatUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    EmailAddress = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DonateUrl = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FilterListId = table.Column<int>(type: "int", nullable: false),
                    SegmentNumber = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    Primariness = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
