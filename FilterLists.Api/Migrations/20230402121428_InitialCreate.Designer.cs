...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Dependent", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterListLanguage", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterListMaintainer", b =>
                {
                    b.Property<int>("FilterListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterListSyntax", b =>
                {
                    b.Property<int>("FilterListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterListTag", b =>
                {
                    b.Property<int>("FilterListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Fork", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.License", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Maintainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Merge", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Software", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.SoftwareSyntax", b =>
                {
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Syntax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Dependent", b =>
                {
                    b.HasOne("FilterLists.Api.Entities.FilterList", "DependencyFilterList")
                        .WithMany("DependentFilterLists")
                        .HasForeignKey("DependencyFilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.Entities.FilterList", "DependentFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterList", b =>
                {
                    b.HasOne("FilterLists.Api.Entities.License", "License")
                        .WithMany("FilterLists")
                        .HasForeignKey("LicenseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsMany("FilterLists.Api.Entities.FilterListViewUrl", "ViewUrls", b1 =>
                        {
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterListLanguage", b =>
                {
                    b.HasOne("FilterLists.Api.Entities.FilterList", "FilterList")
                        .WithMany("FilterListLanguages")
                        .HasForeignKey("FilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.Entities.Language", "Language")
                        .WithMany("FilterListLanguages")
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterListMaintainer", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.Entities.Maintainer", "Maintainer")
                        .WithMany("FilterListMaintainers")
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterListSyntax", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.Entities.Syntax", "Syntax")
                        .WithMany("FilterListSyntaxes")
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.FilterListTag", b =>
                {
                    ...
                    b.HasOne("FilterLists.Api.Entities.Tag", "Tag")
                        .WithMany("FilterListTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Fork", b =>
                {
                    b.HasOne("FilterLists.Api.Entities.FilterList", "ForkFilterList")
                        .WithMany("UpstreamFilterLists")
                        .HasForeignKey("ForkFilterListId")
                        .IsRequired();

                    b.HasOne("FilterLists.Api.Entities.FilterList", "UpstreamFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.Merge", b =>
                {
                    b.HasOne("FilterLists.Api.Entities.FilterList", "IncludedInFilterList")
                        .WithMany("IncludesFilterLists")
                        .HasForeignKey("IncludedInFilterListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilterLists.Api.Entities.FilterList", "IncludesFilterList")
            ...
            modelBuilder.Entity("FilterLists.Api.Entities.SoftwareSyntax", b =>
                {
                    b.HasOne("FilterLists.Api.Entities.Software", "Software")
