    ...
    public partial class AddEasyDutch : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2845, 3249, (short)3, "https://easydutch-ublockorigin.github.io/EasyDutchCDN/EasyDutch.all.txt" },
                    { 2845, 3250, (short)4, "https://cdn.jsdelivr.net/gh/EasyDutch-uBlockOrigin/EasyDutchCDN@main/EasyDutch.all.txt" },
                    { 2845, 3251, (short)5, "https://cdn.jsdelivr.net/gh/EasyDutch-uBlockOrigin/EasyDutch@gh-pages/EasyDutch.all.txt" },
                    { 2845, 3252, (short)6, "https://cdn.jsdelivr.net/gh/EasyDutch-uBlockOrigin/EasyDutch@gh-pages/EasyDutch.txt" },
                    { 2845, 3253, (short)7, "https://easydutch-ublockorigin.github.io/EasyDutchCDN/EasyDutch.txt" },
                    { 2845, 3254, (short)8, "https://cdn.jsdelivr.net/gh/EasyDutch-uBlockOrigin/EasyDutchCDN@main/EasyDutch.txt" },
                    { 2845, 3255, (short)9, "https://raw.githubusercontent.com/EasyDutch-uBlockOrigin/EasyDutch/gh-pages/EasyDutch.all.txt" },
                    { 2845, 3256, (short)10, "https://raw.githubusercontent.com/EasyDutch-uBlockOrigin/EasyDutchCDN/main/EasyDutch.all.txt" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "FilterListViewUrl",
                keyColumns: new[] { "FilterListId", "Id" },
                keyValues: new object[] { 2845, 3256 });
