...
internal static class Endpoints
{
    ...
    internal static void MapEndpoints(this WebApplication app)
    {
        app.MapGet("/languages",
            ...
            // })
            .WithName(nameof(GetLanguages))
            .WithSummary("Gets the languages targeted by the FilterLists.")
            .WithTags(LanguagesTag.Name)
        ...
        app.MapGet("/licenses",
            ...
            //     return Task.CompletedTask;
            // })
            .WithName(nameof(GetLicenses))
            .WithSummary("Gets the licenses applied to the FilterLists.")
            .WithTags(LicensesTag.Name)
            .AddEndpointFilter(DefaultGetCacheFilter)
            .CacheOutput("ExpireDay");
        ...
        app.MapGet("/lists",
            ...
            .WithSummary("Gets the FilterLists.")
            .WithTags(FilterListsTag.Name)
            .AddEndpointFilter(DefaultGetCacheFilter)
            .CacheOutput("ExpireDay");
        ...
        app.MapGet("/lists/{id:int}",
            ...
            .WithSummary("Gets the details of the FilterList.")
            .WithTags(FilterListsTag.Name)
            .AddEndpointFilter(DefaultGetCacheFilter)
            .CacheOutput("ExpireDay");
        ...
        app.MapGet("/maintainers",
            ...
            //     return Task.CompletedTask;
            // })
            .WithName(nameof(GetMaintainers))
            .WithSummary("Gets the maintainers of the FilterLists.")
            .WithTags(MaintainersTag.Name)
            .AddEndpointFilter(DefaultGetCacheFilter)
            .CacheOutput("ExpireDay");
        ...
        app.MapGet("/software",
            ...
            //     return Task.CompletedTask;
            // })
            .WithName(nameof(GetSoftware))
            .WithSummary("Gets the software that subscribes to the FilterLists.")
            .WithTags(SoftwareTag.Name)
            .AddEndpointFilter(DefaultGetCacheFilter)
            .CacheOutput("ExpireDay");
        ...
        app.MapGet("/syntaxes",
            ...
            //     return Task.CompletedTask;
            // })
            .WithName(nameof(GetSyntaxes))
            .WithSummary("Gets the syntaxes of the FilterLists.")
            .WithTags(SyntaxesTag.Name)
            .AddEndpointFilter(DefaultGetCacheFilter)
            .CacheOutput("ExpireDay");
        ...
        app.MapGet("/tags",
            ...
            .WithSummary("Gets the tags of the FilterLists.")
            .WithTags(TagsTag.Name)
            .AddEndpointFilter(DefaultGetCacheFilter)
            .CacheOutput("ExpireDay");
    }
}